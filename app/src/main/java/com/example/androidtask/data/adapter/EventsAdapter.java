...
public class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.MyViewHolder> {
    ...
    Context mContext;
    private List<HomeResponseModel.DataBean.EventsBean> eventsBeanList;

    public EventsAdapter(Context context, List<HomeResponseModel.DataBean.EventsBean> eventsBeanList){
...
//        this.itemListener = itemListener;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final HomeResponseModel.DataBean.EventsBean singleModel = eventsBeanList.get(position);
...
//        }
    ...
    public void updateList(List<HomeResponseModel.DataBean.EventsBean> list){
        eventsBeanList = list;
